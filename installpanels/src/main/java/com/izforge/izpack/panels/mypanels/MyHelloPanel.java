 ...
 * @author Julien Ponge
 */
public class MyHelloPanel extends HelloPanel {
	...
	*/
        ...
        String welcomeText = getString("MyHelloPanel.welcome1") + idata.getInfo().getAppName() + " "
                + idata.getInfo().getAppVersion() + getString("MyHelloPanel.welcome2");
        ...
        if (!authors.isEmpty()) {
            String authorText = getString("MyHelloPanel.authors");
        ...
        if (idata.getInfo().getAppURL() != null) {
            String urlText = getString("MyHelloPanel.url") + idata.getInfo().getAppURL();
