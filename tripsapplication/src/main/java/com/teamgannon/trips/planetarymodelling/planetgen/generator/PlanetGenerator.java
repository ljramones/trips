package com.teamgannon.trips.planetarymodelling.planetgen.generator;
...
import com.teamgannon.trips.planetarymodelling.planetgen.math.RandomColor;
import com.teamgannon.trips.planetarymodelling.planetgen.noise.FractalNoise;
import com.teamgannon.trips.planetarymodelling.planetgen.planet.LayerType;
...
import com.teamgannon.trips.planetarymodelling.planetgen.value.NoisePolarValue;
import com.teamgannon.trips.planetarymodelling.planetgen.value.NoiseSphereValue;
import com.teamgannon.trips.planetarymodelling.planetgen.value.NoiseVector2Value;
import com.teamgannon.trips.planetarymodelling.planetgen.value.SphereValue;
import com.teamgannon.trips.planetarymodelling.util.Random;
...
public class PlanetGenerator {
    ...
    public Planet createEarth(PlanetData planetData) {
        ...
        planet.layers.put(LayerType.CITIES, new CityLayer(
                RandomColor.random(random, rgb(0.66, 0.66, 0.66), rgb(0.45, 0.45, 0.45)),
