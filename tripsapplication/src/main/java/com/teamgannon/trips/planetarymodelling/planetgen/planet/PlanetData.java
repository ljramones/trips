 ...
 * {@link PlanetGenerator#createPlanetData(long...)}.
 */
public class PlanetData {
     ...
     */
    public List<PlantLayer.PlantData> plants = Collections.emptyList();
    /**
     * The list of craters to use during planet creation.
     */
    public List<CraterLayer.Crater> craters = Collections.emptyList();
    /**
     * The list of crater calculators to use during planet creation.
     */
    public List<CraterLayer.CraterCalculator> craterCalculators = Collections.emptyList();
