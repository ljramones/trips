...
@Slf4j
public class FindStarByCatalogIdDialog extends Dialog<StarSearchResults> {

    private final TextField starName = new TextField();
    private final ChoiceBox<String> datasets = new ChoiceBox<>();

    public FindStarByCatalogIdDialog(@NotNull List<String> datasetNames, DataSetDescriptor dataSetDescriptor) {
        ...
        Label starSearchLabel = new Label("Please enter the partial Catalog Id to search: ");
