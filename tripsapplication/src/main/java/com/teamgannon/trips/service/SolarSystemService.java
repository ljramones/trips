...
import com.teamgannon.trips.solarsystem.modelling.habitable.HabitableZoneCalculator;
...
public class SolarSystemService {
    ...
    /**
     * Save generated planets and post-accretion structures (belts) from a StarSystem.
     * This is the preferred method when using the full ACCRETE generation pipeline.
     *
     * @param sourceStar the star for which the system was generated
     * @param starSystem the generated ACCRETE StarSystem object
     * @return the number of planets saved
     */
    @Transactional
    ...
    /**
     * Save asteroid belt and Kuiper belt features from a generated StarSystem.
     *
     * @param sourceStar the host star
     * @param starSystem the generated system with belt data
     */
    @Transactional
