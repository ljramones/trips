...
import com.teamgannon.trips.service.export.tasks.KryoDataExportTask;
...
@Slf4j
public class KryoDataExportService extends Service<ExportResults> implements ExportTaskControl {
    ...
    public KryoDataExportService(StatusUpdaterListener updaterListener) {
    ...
    protected Task<ExportResults> createTask() {
        return new KryoDataExportTask(export, databaseManagementService, starService);
    }
