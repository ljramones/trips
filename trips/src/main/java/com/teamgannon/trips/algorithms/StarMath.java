...
public class StarMath {
     ...
     */
    private static String galacticCenterRA = "17h 45.66m"; // hours minutes
    private static String galacticCenterDec = "-28 56.3";  // degrees minutes

    /***
     * the right ascension and declination of the galactic north pole
     */
    private static String galacticNorthPoleRA = "12h 51.4m"; // hours minutes
    private static String galacticNorthPoleDec = "+27 07.7"; // degrees minutes
