...
public class CHViewPreferences implements Serializable {
     ...
     */
    private Color[] linkColor = new Color[3];
     ...
     */
    private double[] centreOrdinates = new double[3];

    /**
     * not sure what this one is for
     */
    private double[] galCoordinates = new double[3];
     ...
     */
    private String[] namesOfGroups = new String[4];

    /**
     * DisplayGroup x 4 |int |Display each group or not
     */
    private boolean[] displayFlagGroupOn = new boolean[4];
