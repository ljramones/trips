...
public class AstrographicObjectFactory {
     ...
     */
    public static AstrographicObject create(ChViewRecord chViewRecord) {
        AstrographicObject astrographicObject = new AstrographicObject();

        astrographicObject.setId(UUID.randomUUID());

        astrographicObject.setStarType("real");
        ...
        astrographicObject.setStarColor(setColor(chViewRecord.getStarColor()));
