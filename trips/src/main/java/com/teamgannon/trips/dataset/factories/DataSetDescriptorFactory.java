...
public class DataSetDescriptorFactory {
    ...
    public static DataSetDescriptor createDataSetDescriptor(
        ...
        dataSetDescriptor.setDataSetName(chViewFile.getOriginalFileName());
        ...
        if (dataSetDescriptorRepository.exists(dataSetDescriptor.getDataSetName())) {
        ...
        for (Integer recordNumber : chViewRecordMap.keySet()) {
            ...
            AstrographicObject astrographicObject = AstrographicObjectFactory.create(chViewRecord);
        ...
        astrographicObjectRepository.save(astrographicObjectMap.values());
    ...
    public static DataSetDescriptor createDataSetDescriptor(
        ...
        astrographicObjectRepository.save(excelFile.getAstrographicObjects());
        log.info("Number of records load for file:{} is {}",
