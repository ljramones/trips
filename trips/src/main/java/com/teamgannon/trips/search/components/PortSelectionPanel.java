 ...
 */
@Slf4j
public class PortSelectionPanel extends BaseSearchPane {

    private CheckBox yesNoPort = new CheckBox("Yes?");
    private CheckBox aPort = new CheckBox("A");
    private CheckBox bPort = new CheckBox("B");
    private CheckBox cPort = new CheckBox("C");
    private CheckBox dPort = new CheckBox("D");
    private CheckBox ePort = new CheckBox("E");
