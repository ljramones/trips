 ...
 */
@Slf4j
public class TechSelectionPanel extends BaseSearchPane {

    private CheckBox yesTech = new CheckBox("Yes?");
    private CheckBox tech1 = new CheckBox("1");
    private CheckBox tech2 = new CheckBox("2");
    private CheckBox tech3 = new CheckBox("3");
    private CheckBox tech4 = new CheckBox("4");
    private CheckBox tech5 = new CheckBox("5");
    private CheckBox tech6 = new CheckBox("6");
    private CheckBox tech7 = new CheckBox("7");
    private CheckBox tech8 = new CheckBox("8");
    private CheckBox tech9 = new CheckBox("9");
    private CheckBox techA = new CheckBox("A");
    private CheckBox techB = new CheckBox("B");
    private CheckBox techC = new CheckBox("C");
    private CheckBox techD = new CheckBox("D");
    private CheckBox techE = new CheckBox("E");
