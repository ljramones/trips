 ...
 */
@Slf4j
public class PolitySelectionPanel extends BaseSearchPane {

    private CheckBox yesPolity = new CheckBox("Yes?");

    private CheckBox polity1 = new CheckBox("Human");
    private CheckBox polity2 = new CheckBox("Dornaani");
    private CheckBox polity3 = new CheckBox("Ktor");
    private CheckBox polity4 = new CheckBox("Arat Kur");
    private CheckBox polity5 = new CheckBox("Hkh'Rkh");
    private CheckBox polity6 = new CheckBox("Slaasriithi");
    private CheckBox polity7 = new CheckBox("Other 1");
    private CheckBox polity8 = new CheckBox("Other 2");
    private CheckBox polity9 = new CheckBox("Other 3");
    private CheckBox polity10 = new CheckBox("Other 4");
